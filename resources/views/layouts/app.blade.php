                ...
                <div class="flex">
                    ...
                    <div class="hidden sm:-my-px sm:ml-10 sm:flex sm:space-x-8">
                        ...
                        <a href="{{ route('chat.index') }}"
                            class="{{ request()->routeIs('chat.*') ? 'border-indigo-500' : 'border-transparent' }} text-gray-500 hover:text-gray-700 hover:border-gray-300 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
                            Chat
                        </a>
                        <a href="{{ route('drive.index') }}"
                            class="{{ request()->routeIs('drive.*') ? 'border-indigo-500' : 'border-transparent' }} text-gray-500 hover:text-gray-700 hover:border-gray-300 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
                            Shared Drive
                        </a>
