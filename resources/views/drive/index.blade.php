...
@section('content')
        ...
        <div class="p-6 pb-0">
            <div class="flex justify-between items-center mb-6">
                ...
                <div class="space-x-3">
                    <button onclick="document.getElementById('drive-upload-input').click()"
                        class="bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-lg shadow-sm font-medium transition-colors flex items-center">
            ...
            <div id="drop-zone"
                ...
                <div class="dz-message pointer-events-none">
                    ...
                    <p class="mt-2 text-sm text-gray-600">Drag and drop files here, or click to select</p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                ...
                @if ($files->isEmpty())
                    <div class="col-span-full text-center py-12">
                        <p class="text-gray-500">No files shared yet. Be the first to upload!</p>
                    </div>
                @endif
            </div>
        </div>
    ...
    <script>
        ...
        function prepareUpload(file) {
            ...
            document.getElementById('drive-upload-input').value = ''; // Reset input
        }
